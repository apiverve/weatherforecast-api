...
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/weatherforecast";
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WeatherAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WeatherAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, WeatherQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(WeatherQueryOptions options)
        {
        ...
        public ResponseObj Execute(WeatherQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(WeatherQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(WeatherQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(WeatherQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(WeatherQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(WeatherQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(WeatherQueryOptions options)
        {
