/*
 * Weather API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the Weather API.
 * API Documentation: https://docs.apiverve.com/ref/weatherforecast
 */
...
namespace APIVerve.Examples
{
    class WeatherExample
    {
        ...
        private static readonly string API_URL = "https://api.apiverve.com/v1/weatherforecast";

        /// <summary>
        /// Make a GET request to the Weather API
        /// </summary>
        static async Task<JsonDocument> CallWeatherAPI()
        {
            try
            {
        ...
        static async Task Main(string[] args)
        {
            ...
            var result = await CallWeatherAPI();
